...
//        cancel.setText(LocaleController.getString("Cancel", R.string.Send));
...
//        frameLayout.addView(pickerBottomLayout);
        menu.addView(pickerBottomLayout);
        LinearLayout.LayoutParams params = (LinearLayout.LayoutParams)pickerBottomLayout.getLayoutParams();
        params.gravity = Gravity.CENTER;
        pickerBottomLayout.setLayoutParams(params);
//
